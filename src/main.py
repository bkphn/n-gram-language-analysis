...
from graphs import draw_graph, draw_heatmap
from matrices import generate_similarity_matrix
...
if __name__ == '__main__':
    ...
    if SHOW_GRAPH:
        ...
        print(f"\n{GREEN}Generuję mapę ciepła...{RESET}")
        draw_heatmap(similarity_matrix_np, languages_list)
        print(f"{GREEN}Mapa ciepła wygenerowana pomyślnie.{RESET}\n")
    else:
